...
public abstract class ObjectTree{
	...
	public static void growTree(ChunkManager level, int x, int y, int z, BozkurtRandom random){
		growTree(level, x, y, z, random, 0);
	}

	public static void growTree(ChunkManager level, int x, int y, int z, BozkurtRandom random, int type){
		ObjectTree tree;
		switch(type){
	...
	public boolean canPlaceObject(ChunkManager level, int x, int y, int z, BozkurtRandom random){
		int radiusToCheck = 0;
	...
	protected void placeTrunk(ChunkManager level, int x, int y, int z, BozkurtRandom random, int trunkHeight){
		// The base dirt block
