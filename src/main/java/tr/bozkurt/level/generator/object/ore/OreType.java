package tr.bozkurt.level.generator.object.ore;
...
import static tr.bozkurt.block.BlockID.STONE;
...
public class OreType{
	...
	public boolean spawn(ChunkManager level, BozkurtRandom rand, int replaceId, int x, int y, int z){
