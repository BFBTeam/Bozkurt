...
public class PerlinD extends NoiseD{
	...
	public PerlinD(BozkurtRandom random, double octaves, double persistence){
		this(random, octaves, persistence, 1);
	}

	public PerlinD(BozkurtRandom random, double octaves, double persistence, double expansion){
