package tr.bozkurt.level.generator.noise.vanilla.f;
...
public class NoiseGeneratorImprovedF{
	...
	public NoiseGeneratorImprovedF(){
		this(new BozkurtRandom(System.currentTimeMillis()));
	}

	public NoiseGeneratorImprovedF(BozkurtRandom p_i45469_1_){
