package tr.bozkurt.level.generator.noise.bozkurt.f;
...
public class SimplexF extends PerlinF{
	...
	public SimplexF(BozkurtRandom random, float octaves, float persistence){
	...
	public SimplexF(BozkurtRandom random, float octaves, float persistence, float expansion){
