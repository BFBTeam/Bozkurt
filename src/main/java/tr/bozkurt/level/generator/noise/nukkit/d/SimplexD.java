package tr.bozkurt.level.generator.noise.bozkurt.d;
...
public class SimplexD extends PerlinD{
	...
	public SimplexD(BozkurtRandom random, double octaves, double persistence){
	...
	public SimplexD(BozkurtRandom random, double octaves, double persistence, double expansion){
