...
import tr.bozkurt.level.biome.BiomeSelector;
import tr.bozkurt.level.biome.EnumBiome;
import tr.bozkurt.level.format.generic.BaseFullChunk;
import tr.bozkurt.level.generator.noise.vanilla.f.NoiseGeneratorOctavesF;
import tr.bozkurt.level.generator.noise.vanilla.f.NoiseGeneratorPerlinF;
import tr.bozkurt.level.generator.object.ore.OreType;
import tr.bozkurt.level.generator.populator.impl.*;
...
/**
 * Bozkurt's terrain generator
 * Originally adapted from the PocketMine-MP generator by NycuRO and CreeperFace
 * Mostly rewritten by DaPorkchop_
 * <p>
 * The following classes, and others related to terrain generation are theirs and are intended for BOZKURT USAGE and should not be copied/translated to other server software
...
public class Normal extends Generator{
	...
	public void init(ChunkManager level, BozkurtRandom random){
		...
		this.bozkurtRandom.setSeed(this.level.getSeed());
		this.selector = new BiomeSelector(this.bozkurtRandom);
