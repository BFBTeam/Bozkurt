package tr.bozkurt.level.format.generic;

import tr.bozkurt.level.format.FullChunk;
import tr.bozkurt.level.format.LevelProvider;
import tr.bozkurt.level.format.anvil.Chunk;
import tr.bozkurt.level.format.anvil.ChunkSection;
...
public class ChunkConverter{
	...
	public ChunkConverter from(BaseFullChunk chunk){
		if(!(chunk instanceof tr.bozkurt.level.format.mcregion.Chunk) && !(chunk instanceof tr.bozkurt.level.format.leveldb.Chunk)){
