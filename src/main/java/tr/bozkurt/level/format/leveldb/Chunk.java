package tr.bozkurt.level.format.leveldb;
...
import tr.bozkurt.level.format.leveldb.key.EntitiesKey;
import tr.bozkurt.level.format.leveldb.key.ExtraDataKey;
import tr.bozkurt.level.format.leveldb.key.TilesKey;
		...
		try{
			...
			if(provider instanceof LevelDB){
                ...
                /*if (!entities.isEmpty() || !blockEntities.isEmpty()) {
                    ...
                    ct.putList(tileList);
                    NBTIO.write(ct, new File(Bozkurt.DATA_PATH + chunkX + "_" + chunkZ + ".dat"));
                }*/
