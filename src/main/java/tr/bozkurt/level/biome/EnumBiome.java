...
import tr.bozkurt.level.biome.impl.HellBiome;
import tr.bozkurt.level.biome.impl.beach.BeachBiome;
import tr.bozkurt.level.biome.impl.beach.ColdBeachBiome;
import tr.bozkurt.level.biome.impl.desert.DesertBiome;
import tr.bozkurt.level.biome.impl.desert.DesertHillsBiome;
import tr.bozkurt.level.biome.impl.desert.DesertMBiome;
import tr.bozkurt.level.biome.impl.extremehills.*;
import tr.bozkurt.level.biome.impl.forest.FlowerForestBiome;
import tr.bozkurt.level.biome.impl.forest.ForestBiome;
import tr.bozkurt.level.biome.impl.forest.ForestHillsBiome;
import tr.bozkurt.level.biome.impl.iceplains.IcePlainsBiome;
import tr.bozkurt.level.biome.impl.iceplains.IcePlainsSpikesBiome;
import tr.bozkurt.level.biome.impl.jungle.*;
import tr.bozkurt.level.biome.impl.mesa.*;
import tr.bozkurt.level.biome.impl.mushroom.MushroomIslandBiome;
import tr.bozkurt.level.biome.impl.mushroom.MushroomIslandShoreBiome;
import tr.bozkurt.level.biome.impl.ocean.DeepOceanBiome;
import tr.bozkurt.level.biome.impl.ocean.FrozenOceanBiome;
import tr.bozkurt.level.biome.impl.ocean.OceanBiome;
import tr.bozkurt.level.biome.impl.plains.PlainsBiome;
import tr.bozkurt.level.biome.impl.plains.SunflowerPlainsBiome;
import tr.bozkurt.level.biome.impl.river.FrozenRiverBiome;
import tr.bozkurt.level.biome.impl.river.RiverBiome;
import tr.bozkurt.level.biome.impl.roofedforest.RoofedForestBiome;
import tr.bozkurt.level.biome.impl.roofedforest.RoofedForestMBiome;
import tr.bozkurt.level.biome.impl.savanna.SavannaBiome;
import tr.bozkurt.level.biome.impl.savanna.SavannaMBiome;
import tr.bozkurt.level.biome.impl.savanna.SavannaPlateauBiome;
import tr.bozkurt.level.biome.impl.savanna.SavannaPlateauMBiome;
import tr.bozkurt.level.biome.impl.swamp.SwampBiome;
import tr.bozkurt.level.biome.impl.swamp.SwamplandMBiome;
import tr.bozkurt.level.biome.impl.taiga.*;
