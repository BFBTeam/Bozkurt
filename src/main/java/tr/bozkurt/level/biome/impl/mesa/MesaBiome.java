...
import tr.bozkurt.block.BlockSand;
...
public class MesaBiome extends CoveredBiome{
	...
	static final SimplexF redSandNoise = new SimplexF(new BozkurtRandom(937478913), 2f, 1 / 4f, 1 / 4f);
	static final SimplexF colorNoise = new SimplexF(new BozkurtRandom(193759875), 2f, 1 / 4f, 1 / 32f);
	...
	int currMeta = 0;
	int startY = 0;
	private SimplexF moundNoise = new SimplexF(new BozkurtRandom(347228794), 2f, 1 / 4f, getMoundFrequency());
