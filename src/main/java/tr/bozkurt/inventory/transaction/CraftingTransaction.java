package tr.bozkurt.inventory.transaction;

import tr.bozkurt.Player;
import tr.bozkurt.event.inventory.CraftItemEvent;
import tr.bozkurt.inventory.BigCraftingGrid;
import tr.bozkurt.inventory.CraftingRecipe;
...
public class CraftingTransaction extends InventoryTransaction{
	...
	public void setInput(int index, Item item){
		int y = BozkurtMath.floorDouble((double) index / this.gridSize);
