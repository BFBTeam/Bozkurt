package tr.bozkurt.math;

/**
 * Bozkurt Project
 */
public class BozkurtMath{
	...
	public static int randomRange(BozkurtRandom random){
		return randomRange(random, 0);
	}

	public static int randomRange(BozkurtRandom random, int start){
		return randomRange(random, 0, 0x7fffffff);
	}

	public static int randomRange(BozkurtRandom random, int start, int end){
