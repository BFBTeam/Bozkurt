...
import tr.bozkurt.entity.data.LongEntityData;
...
public abstract class EntityProjectile extends Entity{
	...
	public int getResultDamage(){
		return BozkurtMath.ceilDouble(Math.sqrt(this.motionX * this.motionX + this.motionY * this.motionY + this.motionZ * this.motionZ) * getDamage());
	}
