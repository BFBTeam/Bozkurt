...
import tr.bozkurt.block.BlockMagma;
import tr.bozkurt.entity.data.ShortEntityData;
import tr.bozkurt.entity.passive.EntityWaterAnimal;
...
import cn.bozkurt.network.protocol.AnimatePacket;
import tr.bozkurt.network.protocol.EntityEventPacket;
import tr.bozkurt.potion.Effect;
import tr.bozkurt.utils.BlockIterator;
...
public abstract class EntityLiving extends Entity implements EntityDamageable{
	...
	public void kill(){
		...
		if(this.level.getGameRules().getBoolean(GameRule.DO_ENTITY_DROPS)){
			for(tr.bozkurt.item.Item item : ev.getDrops()){
