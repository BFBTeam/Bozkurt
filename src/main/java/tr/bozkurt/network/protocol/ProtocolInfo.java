...
public interface ProtocolInfo{
	...
	int NEWEST_PROTOCOL = Integer.valueOf("500"); //to-do
	int OLDEST_PROTOCOL = Integer.valueOf("282");

	int CURRENT_PROTOCOL = NEWEST_PROTOCOL;

	List<Integer> SUPPORTED_PROTOCOLS = Ints.asList(NEWEST_PROTOCOL);

	String MINECRAFT_VERSION = "v1.9";
	String MINECRAFT_VERSION_NETWORK = "1.9";
