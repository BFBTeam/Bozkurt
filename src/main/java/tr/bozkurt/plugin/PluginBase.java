...
import tr.bozkurt.command.PluginIdentifiableCommand;
...
/**
 * 一般的Bozkurt插件需要继承的类。<br>
 * A class to be extended by a normal Bozkurt plugin.
 *
...
abstract public class PluginBase implements Plugin{
	 ...
	 * @see tr.bozkurt.plugin.PluginDescription#getFullName
	 * @since Bozkurt 1.0 | Bozkurt API 1.0.0
	 */
