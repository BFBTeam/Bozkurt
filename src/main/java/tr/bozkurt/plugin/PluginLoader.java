...
public interface PluginLoader{
	 ...
	 * @see #loadPlugin(File)
	 * @see tr.bozkurt.plugin.PluginBase#init(PluginLoader, tr.bozkurt.Server, PluginDescription, File, File)
	 * @since Bozkurt 1.0 | Bozkurt API 1.0.0
	 */
	 ...
	 *
	 * <p>在Bozkurt读取所有插件时，插件管理器会查找所有已经安装的插件加载器，通过识别这个插件是否满足下面的条件，
	 * 来选择对应的插件加载器。<br>
	 * When Bozkurt is trying to load all its plugins, the plugin manager will look for all installed plugin loader,
