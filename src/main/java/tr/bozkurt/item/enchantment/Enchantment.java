package tr.bozkurt.item.enchantment;

import tr.bozkurt.entity.Entity;
import tr.bozkurt.event.entity.EntityDamageEvent;
import tr.bozkurt.item.Item;
import tr.bozkurt.item.enchantment.bow.EnchantmentBowFlame;
import tr.bozkurt.item.enchantment.bow.EnchantmentBowInfinity;
import tr.bozkurt.item.enchantment.bow.EnchantmentBowKnockback;
import tr.bozkurt.item.enchantment.bow.EnchantmentBowPower;
import tr.bozkurt.item.enchantment.damage.EnchantmentDamageAll;
import tr.bozkurt.item.enchantment.damage.EnchantmentDamageArthropods;
import tr.bozkurt.item.enchantment.damage.EnchantmentDamageSmite;
import tr.bozkurt.item.enchantment.loot.EnchantmentLootDigging;
import tr.bozkurt.item.enchantment.loot.EnchantmentLootFishing;
import tr.bozkurt.item.enchantment.loot.EnchantmentLootWeapon;
import tr.bozkurt.item.enchantment.protection.*;
