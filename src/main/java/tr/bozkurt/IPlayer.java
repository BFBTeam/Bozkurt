...
import tr.bozkurt.permission.ServerOperator;
 ...
 * @see tr.bozkurt.Player
 * @see tr.bozkurt.OfflinePlayer
...
public interface IPlayer extends ServerOperator, Metadatable{
	 ...
	 *
	 * <p>如果是在线的玩家，这个函数只会返回登录名字。如果要返回显示的名字，参见{@link tr.bozkurt.Player#getDisplayName}<br>
	 * Notice that this will only return its login name. If you need its display name, turn to
	 * {@link tr.bozkurt.Player#getDisplayName}</p>
	 *
	 ...
	 * @see tr.bozkurt.Server#isWhitelisted
	 * @since Bozkurt 1.0 | Bozkurt API 1.0.0
	 */
	 ...
	 * @see #isWhitelisted
	 * @see tr.bozkurt.Server#addWhitelist
	 * @see tr.bozkurt.Server#removeWhitelist
	 * @since Bozkurt 1.0 | Bozkurt API 1.0.0
	 */
	 ...
	 * @see tr.bozkurt.Server#getPlayerExact
	 * @since Bozkurt 1.0 | Bozkurt API 1.0.0
	 */
	Player getPlayer();
