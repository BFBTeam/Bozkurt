 ...
 *
 * <p>事件监听器被注册后，Bozkurt会在需要监听的事件发生时，使用反射来调用监听类中对应的处理器。<br>
 * After registered, Bozkurt will call the handler in the listener classes by reflection when a event happens.</p>
 *
 ...
 * </pre>
 *
 * <p>关于注册监听类，请看：{@link tr.bozkurt.plugin.PluginManager#registerEvents}.<br>
 * For registering listener class, See: {@link tr.bozkurt.plugin.PluginManager#registerEvents}.</p>
 *
