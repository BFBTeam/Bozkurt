...
public abstract class DefaultPermissions{
	...
	public static final String ROOT = "bozkurt";
	...
	public static void registerCorePermissions(){
		Permission parent = registerPermission(new Permission(ROOT, "Allows using all Bozkurt commands and utilities"));
		...
		Permission commands = registerPermission(new Permission(ROOT + ".command", "Allows using all Bozkurt commands"), parent);
