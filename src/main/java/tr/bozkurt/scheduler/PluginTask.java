 ...
 * </pre>
 *
 * <p>如果要让Bozkurt能够延时或循环执行这个任务，请使用{@link ServerScheduler}。<br>
 * If you want Bozkurt to execute this task with delay or repeat, use {@link ServerScheduler}.</p>
 *
