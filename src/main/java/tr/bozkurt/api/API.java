...
import static tr.bozkurt.api.API.Definition.UNIVERSAL;
import static tr.bozkurt.api.API.Usage.BLEEDING;

/**
 * Describes an API element.
 *
 * @author Lin Mulan, Bozkurt Project
 * @see Usage
 * @see Definition
 */
...
public @interface API{
	...
	enum Definition{
		...
		/**
		 * Intended for features should only be used by Bozkurt itself.
