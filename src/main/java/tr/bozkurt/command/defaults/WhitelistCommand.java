...
public class WhitelistCommand extends VanillaCommand{
	...
	public WhitelistCommand(String name){
		super(name, "%bozkurt.command.whitelist.description", "%commands.whitelist.usage");
		this.setPermission(
				"bozkurt.command.whitelist.reload;" +
						"bozkurt.command.whitelist.enable;" +
						"bozkurt.command.whitelist.disable;" +
						"bozkurt.command.whitelist.list;" +
						"bozkurt.command.whitelist.add;" +
						"bozkurt.command.whitelist.remove"
		);
	...
	private boolean badPerm(CommandSender sender, String perm){
		if(!sender.hasPermission("bozkurt.command.whitelist" + perm)){
