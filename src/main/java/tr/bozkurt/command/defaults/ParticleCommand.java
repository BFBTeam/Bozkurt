...
import tr.bozkurt.level.particle.*;
...
public class ParticleCommand extends VanillaCommand{
	...
	public ParticleCommand(String name){
		super(name, "%bozkurt.command.particle.description", "%bozkurt.command.particle.usage");
		this.setPermission("bozkurt.command.particle");
