...
public class TeleportCommand extends VanillaCommand{
	...
	public TeleportCommand(String name){
		super(name, "%bozkurt.command.tp.description", "%commands.tp.usage");
		this.setPermission("bozkurt.command.teleport");
	...
	public boolean execute(CommandSender sender, String commandLabel, String[] args){
		...
		if(args.length < 3){
			...
			Command.broadcastCommandMessage(sender, new TranslationContainer("commands.tp.success.coordinates", new String[]{target.getName(), String.valueOf(BozkurtMath.round(x, 2)), String.valueOf(BozkurtMath.round(y, 2)), String.valueOf(BozkurtMath.round(z, 2))}));
			return true;
		}
		sender.sendMessage(new TranslationContainer("commands.generic.usage", this.usageMessage));
		return true;
